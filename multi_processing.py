...
if __name__ == "__main__":
    ...
    maximo_de_procesos_activos = int(input("Digite el numero de unidades de procesamiento (procesos): "))
    ...
    for url_y_nombre in urls_y_nombres:
        ...
        for numero_de_video in range(1, videos_por_canal + 1): 
            ...
            # numero_de_procesos_activos = multiprocessing.active_children()
            # print("Procesos en ejecucion:", numero_de_procesos_activos)
            # while(numero_de_procesos_activos >= maximo_de_procesos_activos):
            #     numero_de_procesos_activos = multiprocessing.active_children()
            
            thread = multiprocessing.Process(target = d_v_y_e_a, args=(numero_de_video, url_y_nombre))
